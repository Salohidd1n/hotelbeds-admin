...
import {
	useDownTargetDestinationsDelete,
	useGetDownTargetDestinations,
} from 'services/down-target-destinations.service';

const DownTargetDestinationsListPage = () => {
	...
	const { data, isLoading, refetch } = useGetDownTargetDestinations({
		params: {
			page,
			limit: pageSize,
			search: term,
		...
		<>
			<Box>
				<Header>
					<HeaderLeftSide>
						<HeaderTitle>
              Get closer to the Europe you want to visit
						</HeaderTitle>
					</HeaderLeftSide>
					<HeaderExtraSide>
						<NotificationMenu />
...
export default DownTargetDestinationsListPage;
